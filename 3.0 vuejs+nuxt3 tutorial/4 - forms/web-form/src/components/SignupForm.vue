<template>
    <form @submit.prevent="handleSubmit">
        ...
        <div v-for="skill in skills" :key="skill" class="pill" @click="removeSkill(skill)" title="click to remove">
            {{skill}}
        </div>
        <div class="terms">
        ...
        methods:{
            addSkill(e){
                if(e.key === 'Enter' && this.tempSkill){
                    // if(this.tempSkill.includes(',')){
                        this.tempSkill.split(',').forEach(skill => {
